...
css
    ...
    production builds generated by Sass.
scss
    Should contain all the scss files for the site. Additional vendor
...
Because all the stylesheets are using Sass we need to compile them
...
There are many Sass files which attempt to group the styles in useful
