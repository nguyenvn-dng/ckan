...
(function() {
  ...
  ckan.module('add-dataset-modal', function($) {
  return {
    initialize: function() {
      $.proxyAll(this, /_on/)
...
(function() {
  ...
  ckan.module('expand-dataset', function($) {
  return {
    initialize: function() {
      $.proxyAll(this, /_on/)
...
(function() {
  ...
  ckan.module('filter-requests', function($) {
...
(function() {
  ...
  ckan.module('handle-open-request', function($) {
  ...
  return {
    initialize: function() {
      ...
      this.api = {
        get: function(action, params) {
            var base_url = self.sandbox.client.endpoint
            params = $.param(params)
    ...
    _onClick: function(event) {
      ...
      var base_url = this.sandbox.client.endpoint
...
(function() {
  ...
  ckan.module('modal-form', function($) {
    return {
        initialize: function() {
            var self = this;
            this.api = {
