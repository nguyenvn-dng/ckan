...
this.ckan.module('image-upload', function($) {
  return {
    ...
    initialize: function () {
      ...
      this.button_url = $('<a href="javascript:;" class="btn btn-default btn-default-custom">' +
      ...
      this.button_upload = $('<a href="javascript:;" class="btn btn-default btn-default-custom">' +
